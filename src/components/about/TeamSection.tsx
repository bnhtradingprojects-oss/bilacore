    ...
    <section id="team" className="relative py-24  overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            <h2 className="text-5xl font-bold mb-6  drop-shadow-text">
              Meet Our Team
            </h2>
            <div className="h-1 w-20 bg-[var(--color-yellow)] mx-auto shadow-glow" />
          </motion.div>
          <p className="text-2xl /90 max-w-3xl mx-auto mt-8 leading-relaxed">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {team.map((member, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative    rounded-2xl overflow-hidden p-0 mb-8 ">
                <Image
                  src={member.image}
                  alt={member.name}
                  width={300}
              ...
              <div className="text-center">
                <h3 className="text-2xl font-bold mb-3  group-hover:text-[var(--color-yellow-light)] transition-colors duration-300 drop-shadow-text">
                  {member.name}
                </h3>
                <p className="text-lg font-medium text-[var(--color-yellow)] mb-4 drop-shadow">{member.role}</p>
                <p className="/90 leading-relaxed">{member.bio}</p>
              </div>
              <motion.div 
              ...
              >
                <a href="#" className="/70 hover:text-[var(--color-yellow-light)] transition-colors duration-300 hover:drop-shadow-glow">
